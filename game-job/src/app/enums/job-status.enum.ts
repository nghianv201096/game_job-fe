...
export class JobStatusEnum extends BaseTypeEnum {
    ...
    static Display = new JobStatusEnum(3, 'Đang hiển thị', 'Đang hiển thị');
    static Strip = new JobStatusEnum(3, 'Đã gỡ', 'Đã gỡ');
    static OutOfDate = new JobStatusEnum(3, 'Hết hạn', 'Hết hạn');
